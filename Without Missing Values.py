...
#Drop rows with missing values in the 'Find_website' and 'Ease_of_purchase' columns
data.dropna(inplace=True)
#Drop rows with values of -999 in the 'Time_Spent_on_Website' and 'Number_of_products_browsed' columns
data = data[(data['Time_Spent_on_Website'] != -999) & (data['Number_of_products_browsed'] != -999)]
